                    ...
                    @foreach($orders as $key=>$order)
                        <tr class="status-{{$order['order_status']}} class-all">
                            ...
                            <td class="table-column-pl-0">
                                <a href="{{route('admin.table.order.details',['id'=>$order['id']])}}">{{$order['id']}}</a>
                            </td>
                            ...
                            <td>
                                <a class="btn btn-sm btn-white"
                                           href="{{route('admin.table.order.details',['id'=>$order['id']])}}"><i
...
@push('script_2')
    ...
    <script>
        function filter_branch_orders(id) {
            location.href = '{{url('/')}}/admin/table/order/branch-filter/' + id;
        }
    </script>
